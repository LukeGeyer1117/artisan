...
class Artisan(models.Model):
    ...
    price_range_low = models.DecimalField(max_digits=10, decimal_places=2, default=0)
    price_range_high = models.DecimalField(max_digits=10, decimal_places=2, default=100)
